...
import { ShareIcon, DownloadIcon, CopyIcon, SunIcon, MoonIcon } from './components/widgets/Icons';
...
const App: React.FC = () => {
  ...
  return (
    <div className={`min-h-screen relative flex justify-center pt-8 pb-12 px-4 md:px-8 overflow-x-hidden ${darkMode ? 'bg-slate-950 text-white selection:bg-teal-900 selection:text-white' : 'bg-slate-50 text-slate-900 selection:bg-teal-300 selection:text-teal-900'}`}>
      ...
      <div className={`fixed top-0 left-0 right-0 h-96 bg-linear-to-b ${darkMode ? 'from-teal-900/20 via-slate-900/0' : 'from-teal-50/80 via-white/80'} to-transparent z-0 pointer-events-none transition-colors duration-700`} />
      <div className={`fixed -top-40 left-1/2 -translate-x-1/2 w-600 h-600 ${darkMode ? 'bg-teal-500/10' : 'bg-teal-200/20'} rounded-full blur-[100px] z-0 pointer-events-none transition-colors duration-700`} />
          ...
          <section className="md:col-span-7 lg:col-span-8 flex flex-col gap-8">
            ...
            <div className="grid grid-cols-2 gap-4 md:gap-6">
              ...
              <div className="col-span-2">
                <LinkCard link={socialLinks[0]} variant="featured" className="h-full min-h-180" darkMode={darkMode} />
              </div>
